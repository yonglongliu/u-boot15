...
#define REG_AON_CLK_CORE_CGM_WCDMA_CFG            ( CTL_BASE_AON_CLK_CORE + 0x00F0 )
#define REG_AON_CLK_CORE_CGM_AP_AXI_CFG           ( CTL_BASE_AON_CLK_CORE + 0x00F4 )
#define REG_AON_CLK_CORE_CGM_AP_MM_CFG            ( CTL_BASE_AON_CLK_CORE + 0x00F8 )
#define REG_AON_CLK_CORE_CGM_SDIO2_2X_CFG         ( CTL_BASE_AON_CLK_CORE + 0x00FC )
#define REG_AON_CLK_CORE_CGM_SDIO2_1X_CFG         ( CTL_BASE_AON_CLK_CORE + 0x0100 )
#define REG_AON_CLK_CORE_CGM_ANALOG_IO_APB_CFG    ( CTL_BASE_AON_CLK_CORE + 0x0104 )
#define REG_AON_CLK_CORE_CGM_DMC_REF_CFG          ( CTL_BASE_AON_CLK_CORE + 0x0108 )
#define REG_AON_CLK_CORE_CGM_USB20_SCAN_ONLY_CFG  ( CTL_BASE_AON_CLK_CORE + 0x010C )
#define REG_AON_CLK_CORE_CGM_EMC_CFG              ( CTL_BASE_AON_CLK_CORE + 0x0110 )
#define REG_AON_CLK_CORE_CGM_USB_CFG              ( CTL_BASE_AON_CLK_CORE + 0x0114 )
#define REG_AON_CLK_CORE_CGM_EFUSE_ESE_CFG        ( CTL_BASE_AON_CLK_CORE + 0x0118 )
#define REG_AON_CLK_CORE_CGM_AAPC_TEST_CFG        ( CTL_BASE_AON_CLK_CORE + 0x011C )
