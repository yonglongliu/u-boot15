...
#define SPRD_EIC_PHYS				SPRD_AON_EIC_EXT0_PHYS
#define SPRD_EIC1_PHYS				SPRD_AON_EIC_EXT1_PHYS
...
#define BIT_USB_EB                              BIT_AON_APB_OTG_PHY_EB

/* referenced by whalek_usb_phy.c */
