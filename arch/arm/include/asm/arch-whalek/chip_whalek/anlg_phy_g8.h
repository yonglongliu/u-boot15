...
#define REG_ANLG_PHY_G8_ANALOG_THM2_1_THM2_RESERVED_CTL       ( CTL_BASE_ANLG_PHY_G8 + 0x0004 )
#define REG_ANLG_PHY_G8_ANALOG_THM2_1_WRAP_GLUE_CTRL          ( CTL_BASE_ANLG_PHY_G8 + 0x0008 )
#define REG_ANLG_PHY_G8_ANALOG_EFUSE1_0_EFUSE_PIN_PW_CTL      ( CTL_BASE_ANLG_PHY_G8 + 0x000C )
#define REG_ANLG_PHY_G8_ANALOG_EFUSE1_1_EFUSE_PIN_PW_CTL      ( CTL_BASE_ANLG_PHY_G8 + 0x0010 )
