...
#define REG_PUB_AHB_RF_MPU_CFG0               ( CTL_BASE_PUB_AHB + 0x3020 )
#define REG_PUB_AHB_RF_MPU_CFG0_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3024 )
#define REG_PUB_AHB_RF_MPU_CFG0_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3028 )
#define REG_PUB_AHB_RF_MPU_CFG0_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x302C )
#define REG_PUB_AHB_RF_MPU_CFG1               ( CTL_BASE_PUB_AHB + 0x3030 )
#define REG_PUB_AHB_RF_MPU_CFG1_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3034 )
#define REG_PUB_AHB_RF_MPU_CFG1_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3038 )
#define REG_PUB_AHB_RF_MPU_CFG1_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x303C )
#define REG_PUB_AHB_RF_MPU_CFG2               ( CTL_BASE_PUB_AHB + 0x3040 )
#define REG_PUB_AHB_RF_MPU_CFG2_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3044 )
#define REG_PUB_AHB_RF_MPU_CFG2_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3048 )
#define REG_PUB_AHB_RF_MPU_CFG2_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x304C )
#define REG_PUB_AHB_RF_MPU_CFG3               ( CTL_BASE_PUB_AHB + 0x3050 )
#define REG_PUB_AHB_RF_MPU_CFG3_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3054 )
#define REG_PUB_AHB_RF_MPU_CFG3_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3058 )
#define REG_PUB_AHB_RF_MPU_CFG3_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x305C )
#define REG_PUB_AHB_RF_MPU_CFG4               ( CTL_BASE_PUB_AHB + 0x3060 )
#define REG_PUB_AHB_RF_MPU_CFG4_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3064 )
#define REG_PUB_AHB_RF_MPU_CFG4_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3068 )
#define REG_PUB_AHB_RF_MPU_CFG4_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x306C )
#define REG_PUB_AHB_RF_MPU_CFG5               ( CTL_BASE_PUB_AHB + 0x3070 )
#define REG_PUB_AHB_RF_MPU_CFG5_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3074 )
#define REG_PUB_AHB_RF_MPU_CFG5_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3078 )
#define REG_PUB_AHB_RF_MPU_CFG5_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x307C )
#define REG_PUB_AHB_RF_MPU_CFG6               ( CTL_BASE_PUB_AHB + 0x3080 )
#define REG_PUB_AHB_RF_MPU_CFG6_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3084 )
#define REG_PUB_AHB_RF_MPU_CFG6_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3088 )
#define REG_PUB_AHB_RF_MPU_CFG6_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x308C )
#define REG_PUB_AHB_RF_MPU_CFG7               ( CTL_BASE_PUB_AHB + 0x3090 )
#define REG_PUB_AHB_RF_MPU_CFG7_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x3094 )
#define REG_PUB_AHB_RF_MPU_CFG7_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x3098 )
#define REG_PUB_AHB_RF_MPU_CFG7_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x309C )
#define REG_PUB_AHB_RF_MPU_CFG8               ( CTL_BASE_PUB_AHB + 0x30A0 )
#define REG_PUB_AHB_RF_MPU_CFG8_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x30A4 )
#define REG_PUB_AHB_RF_MPU_CFG8_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x30A8 )
#define REG_PUB_AHB_RF_MPU_CFG8_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x30AC )
#define REG_PUB_AHB_RF_MPU_CFG9               ( CTL_BASE_PUB_AHB + 0x30B0 )
#define REG_PUB_AHB_RF_MPU_CFG9_ID_MASK_VAL   ( CTL_BASE_PUB_AHB + 0x30B4 )
#define REG_PUB_AHB_RF_MPU_CFG9_LOW_RANGE     ( CTL_BASE_PUB_AHB + 0x30B8 )
#define REG_PUB_AHB_RF_MPU_CFG9_HIGH_RANGE    ( CTL_BASE_PUB_AHB + 0x30BC )
#define REG_PUB_AHB_RF_MPU_CFG10              ( CTL_BASE_PUB_AHB + 0x30C0 )
#define REG_PUB_AHB_RF_MPU_CFG10_ID_MASK_VAL  ( CTL_BASE_PUB_AHB + 0x30C4 )
#define REG_PUB_AHB_RF_MPU_CFG10_LOW_RANGE    ( CTL_BASE_PUB_AHB + 0x30C8 )
#define REG_PUB_AHB_RF_MPU_CFG10_HIGH_RANGE   ( CTL_BASE_PUB_AHB + 0x30CC )
#define REG_PUB_AHB_RF_MPU_CFG11              ( CTL_BASE_PUB_AHB + 0x30D0 )
#define REG_PUB_AHB_RF_MPU_CFG11_ID_MASK_VAL  ( CTL_BASE_PUB_AHB + 0x30D4 )
#define REG_PUB_AHB_RF_MPU_CFG11_LOW_RANGE    ( CTL_BASE_PUB_AHB + 0x30D8 )
#define REG_PUB_AHB_RF_MPU_CFG11_HIGH_RANGE   ( CTL_BASE_PUB_AHB + 0x30DC )
#define REG_PUB_AHB_RF_MPU_CFG12              ( CTL_BASE_PUB_AHB + 0x30E0 )
#define REG_PUB_AHB_RF_MPU_CFG12_ID_MASK_VAL  ( CTL_BASE_PUB_AHB + 0x30E4 )
#define REG_PUB_AHB_RF_MPU_CFG12_LOW_RANGE    ( CTL_BASE_PUB_AHB + 0x30E8 )
#define REG_PUB_AHB_RF_MPU_CFG12_HIGH_RANGE   ( CTL_BASE_PUB_AHB + 0x30EC )
#define REG_PUB_AHB_RF_MPU_CFG13              ( CTL_BASE_PUB_AHB + 0x30F0 )
#define REG_PUB_AHB_RF_MPU_CFG13_ID_MASK_VAL  ( CTL_BASE_PUB_AHB + 0x30F4 )
#define REG_PUB_AHB_RF_MPU_CFG13_LOW_RANGE    ( CTL_BASE_PUB_AHB + 0x30F8 )
#define REG_PUB_AHB_RF_MPU_CFG13_HIGH_RANGE   ( CTL_BASE_PUB_AHB + 0x30FC )
#define REG_PUB_AHB_RF_MPU_CFG14              ( CTL_BASE_PUB_AHB + 0x3100 )
#define REG_PUB_AHB_RF_MPU_CFG14_ID_MASK_VAL  ( CTL_BASE_PUB_AHB + 0x3104 )
#define REG_PUB_AHB_RF_MPU_CFG14_LOW_RANGE    ( CTL_BASE_PUB_AHB + 0x3108 )
#define REG_PUB_AHB_RF_MPU_CFG14_HIGH_RANGE   ( CTL_BASE_PUB_AHB + 0x310C )
#define REG_PUB_AHB_RF_MPU_CFG15              ( CTL_BASE_PUB_AHB + 0x3110 )
#define REG_PUB_AHB_RF_MPU_CFG15_ID_MASK_VAL  ( CTL_BASE_PUB_AHB + 0x3114 )
#define REG_PUB_AHB_RF_MPU_CFG15_LOW_RANGE    ( CTL_BASE_PUB_AHB + 0x3118 )
#define REG_PUB_AHB_RF_MPU_CFG15_HIGH_RANGE   ( CTL_BASE_PUB_AHB + 0x311C )
