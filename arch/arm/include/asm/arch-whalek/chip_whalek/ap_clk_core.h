...
#define REG_AP_CLK_CORE_CGM_VDSP_CFG               ( CTL_BASE_AP_CLK_CORE + 0x00AC )
#define REG_AP_CLK_CORE_CGM_VDSP_EDAP_CFG          ( CTL_BASE_AP_CLK_CORE + 0x00B0 )
#define REG_AP_CLK_CORE_CGM_VDSP_M0_CFG            ( CTL_BASE_AP_CLK_CORE + 0x00B4 )
