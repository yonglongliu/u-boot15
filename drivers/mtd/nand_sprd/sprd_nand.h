...
#define _CFG3_unused_POLY4R1_SEL(sel)		(((sel)&0x1)<<1)
...
#define _MACH_ERASE					((1)|(1<<8)|(1<<16))	// check IO 0_bit, stop if error
#define _MACH_WRITE					((1)|(1<<8)|(1<<16))	// check IO 0_bit, stop if error
