...
static uint32_t lcd_module_id_to_kernel = 0;
...
void inline save_lcd_module_id_to_kernel(uint32_t id)
{
	lcd_module_id_to_kernel = id;
}

uint32_t inline load_lcd_module_id_to_kernel(void)
{
	return lcd_module_id_to_kernel;
}
