...
#ifdef CONFIG_FPGA
#if !((defined(CONFIG_SC9833)) || (defined(CONFIG_SOC_SHARKLJ1)) || (defined(CONFIG_SOC_SHARKLE)) || (defined(CONFIG_SOC_PIKE2)) || (defined(CONFIG_SOC_SHARKL3)) ||  (defined(CONFIG_SOC_WHALEK)))
	usc28c_dsi_init();
#endif
#endif
	dsi_reset();
