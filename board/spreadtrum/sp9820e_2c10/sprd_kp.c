...
{
//	sprd_gpio_request(NULL, 90);
//	sprd_gpio_direction_output(NULL, 90, 1);
//	udelay(100); //wait 100us
	
	sprd_gpio_request(NULL, 63);
	sprd_gpio_direction_input(NULL, 63);
...
*/
    ...
    gpio_volumeup = sprd_gpio_get(NULL, 63);
    if(gpio_volumeup < 0)
