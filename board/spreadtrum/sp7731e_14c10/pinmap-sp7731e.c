...
{REG_PIN_CTRL2,0x00438010},//SIM2->AP SIM0; SIM1->PUBCP SIM1; SIM0->PUBCP SIM0; UART0->PUBCP UART0; UART1->AP UART1;
{REG_PIN_CTRL3,0x00000400},//IIS0->AP IIS0;IIS1->TGDSP IIS0;
...
{REG_MISC_PIN_MTCK_ARM,                 BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_WPD},//MTCK
{REG_PIN_MTMS_ARM,                      BITS_PIN_AF(0)|BIT_PIN_SLP_NONE|BIT_PIN_SLP_Z},
{REG_MISC_PIN_MTMS_ARM,                 BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_WPD},//MTMS
...
{REG_MISC_PIN_KEYIN2,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//G_INT
{REG_PIN_KEYOUT0,                       BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_IE},
{REG_MISC_PIN_KEYOUT0,                  BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_WPU},//HALL_INT
...
{REG_PIN_SPI_HS_DO,                     BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_IE},
{REG_MISC_PIN_SPI_HS_DO,                BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPU|BIT_PIN_SLP_WPU},//OTG_ID
{REG_PIN_SPI_HS_DI,                     BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_OE},
{REG_MISC_PIN_SPI_HS_DI,                BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_NUL},//OTG_EN
{REG_PIN_SPI_HS_CLK,                    BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_OE},
{REG_MISC_PIN_SPI_HS_CLK,               BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_NUL},//SENSOR_RST
{REG_PIN_SPI_HS_CSN,                    BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_Z},
...
{REG_PIN_RFCTL8,                        BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_Z},
{REG_MISC_PIN_RFCTL8,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//NC
{REG_PIN_RFCTL7,                        BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_Z},
{REG_MISC_PIN_RFCTL7,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//NC
{REG_PIN_RFCTL6,                        BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_Z},
{REG_MISC_PIN_RFCTL6,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//NC
{REG_PIN_RFCTL5,                        BITS_PIN_AF(3)|BIT_PIN_SLP_AP|BIT_PIN_SLP_Z},
{REG_MISC_PIN_RFCTL5,                   BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_WPD|BIT_PIN_SLP_WPD},//NC
