...
{REG_PIN_SPI_HS_DO,                     BITS_PIN_AF(0)|BIT_PIN_SLP_AP|BIT_PIN_SLP_OE},
{REG_MISC_PIN_SPI_HS_DO,                BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_WPD},//FTID_SPI_DI
{REG_PIN_SPI_HS_DI,                     BITS_PIN_AF(0)|BIT_PIN_SLP_AP|BIT_PIN_SLP_IE},
{REG_MISC_PIN_SPI_HS_DI,                BITS_PIN_DS(1)|BIT_PIN_NULL|BIT_PIN_NUL|BIT_PIN_SLP_WPD},//FTID_SPI_DO
{REG_PIN_SPI_HS_CLK,                    BITS_PIN_AF(0)|BIT_PIN_SLP_AP|BIT_PIN_SLP_OE},
